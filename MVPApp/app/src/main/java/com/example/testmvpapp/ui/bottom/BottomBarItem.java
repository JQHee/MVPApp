...
public class BottomBarItem extends LinearLayoutCompat {
    ...
    private View initView() {
        ...
        mImageView = (AppCompatImageView) view.findViewById(R.id.iv_icon);
        mTvUnread = (AppCompatTextView) view.findViewById(R.id.tv_unred_num);
        mTvMsg = (AppCompatTextView) view.findViewById(R.id.tv_msg);
        mTvNotify = (AppCompatTextView) view.findViewById(R.id.tv_point);
        mTextView = (AppCompatTextView) view.findViewById(R.id.tv_text);
        return view;
    }
